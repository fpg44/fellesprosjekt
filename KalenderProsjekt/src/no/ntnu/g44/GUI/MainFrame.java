	...
	public class ListeningClass implements MouseMotionListener, ActionListener, 
		...
		public void keyPressed(KeyEvent e) {
			...
			if(e.getSource() == searchField){
				...
				if((e.getKeyChar() >= 'a' && e.getKeyChar() <= 'z') || (e.getKeyChar() >= 'A' && e.getKeyChar() <= 'Z') || e.getKeyChar() == '-' || e.getKeyChar() == 'ј' || e.getKeyChar() == 'х' || e.getKeyChar() == 'ц' || e.getKeyChar() == 'Х' || e.getKeyChar() == 'и' || e.getKeyChar() == 'Ц'){
					search += e.getKeyChar();
				}
